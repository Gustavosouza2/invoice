...
export default function HomeView() {
  ...
  return (
    <main className="flex flex-col gap-5 py-6 mt-10 md:mt-0 px-4 sm:px-6 lg:px-10 items-center justify-start scrollbar-hide min-h-[calc(100vh-8rem)] md:min-h-0">
